...
const SHORTCUTS = [
  { label: "الموردون", href: "/erp/purchases/suppliers", icon: "Truck", key: "suppliers" },
  { label: "أوامر الشراء", href: "/erp/purchases/orders", icon: "ClipboardList", key: "orders" },
  { label: "أمر شراء جديد", href: "/erp/purchases/orders/new", icon: "Plus" },
  { label: "إذون الاستلام", href: "/erp/purchases/receipts", icon: "PackageCheck" },
  { label: "فواتير الشراء", href: "/erp/purchases/invoices", icon: "ReceiptText", key: "invoices" },
  { label: "سندات الصرف", href: "/erp/purchases/payments", icon: "Banknote" },
  { label: "أعمار الذمم الدائنة", href: "/erp/purchases/aging", icon: "CalendarClock" },
  { label: "ترتيب الموردين", href: "/erp/purchases/reports/suppliers", icon: "BarChart3" },
];
...
export default async function ErpPurchasesPage() {
  ...
  const todos = [
    ...
    { label: "أوامر شراء بانتظار الاستلام", hint: "مؤكّدة أو مستلمة جزئياً", count: cnt(poOpen), href: "/erp/purchases/orders", icon: "PackageCheck" },
    { label: "استلامات لم تُفوتر", hint: "بضاعة مستلمة بانتظار فاتورة المورّد", count: cnt(grni), href: "/erp/purchases/receipts", icon: "FileWarning" },
    { label: "فواتير شراء مسودة", hint: "بانتظار الترحيل", count: cnt(piDraft), href: "/erp/purchases/invoices", icon: "ReceiptText" },
    { label: "فواتير تجاوزت تاريخ السداد", hint: "مستحقة للموردين", count: cnt(overdue), href: "/erp/purchases/aging", icon: "CalendarClock" },
  ];
