...
const SHORTCUTS = [
  { label: "الموظفون", href: "/erp/hr/employees", icon: "UsersRound", key: "employees" },
  { label: "الإجازات", href: "/erp/hr/leaves", icon: "CalendarDays", key: "leaves" },
  { label: "طلب إجازة جديد", href: "/erp/hr/leaves/new", icon: "Plus" },
  { label: "تقرير الإجازات", href: "/erp/hr/leaves/report", icon: "BarChart3" },
  { label: "مسير الرواتب", href: "/erp/hr/payroll", icon: "Banknote", key: "payroll" },
  { label: "مسير رواتب جديد", href: "/erp/hr/payroll/new", icon: "Plus" },
  { label: "مطالبات المصروفات", href: "/erp/hr/expense-claims", icon: "ReceiptText", key: "claims" },
  { label: "تقويم العطلات", href: "/erp/hr/holidays", icon: "CalendarOff" },
];
...
export default async function ErpHrPage() {
  ...
  const todos = [
    { label: "طلبات إجازة بانتظار الاعتماد", hint: "مسودة", count: cnt(leavePending), href: "/erp/hr/leaves", icon: "CalendarDays" },
    { label: "مطالبات مصروفات بانتظار الاعتماد", hint: "مسودة", count: cnt(claimsPending), href: "/erp/hr/expense-claims", icon: "ReceiptText" },
    { label: "مسيّرات رواتب مسودة", hint: "بانتظار الترحيل", count: cnt(runDraft), href: "/erp/hr/payroll", icon: "Banknote" },
  ];
