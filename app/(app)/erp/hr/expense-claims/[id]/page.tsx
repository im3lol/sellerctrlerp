  ...
  return loadErpPage("accounting.view", async ({ orgId, can }) => {
    ...
    return (
      <div className="space-y-6">
        <ErpPageHeader icon="ReceiptText" title={`مطالبة ${claim.number}`} subtitle={`${claim.employee} · ${dt(claim.date)} · التعويض من ${claim.cashName ?? "—"}`} backHref="/erp/hr/expense-claims"
