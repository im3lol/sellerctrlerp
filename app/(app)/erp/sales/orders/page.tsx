        ...
        <ErpPageHeader
          ...
          action={canManage ? (
            <div className="flex gap-2">
              <Button variant="outline" asChild><Link href="/erp/platforms"><Icon name="Store" className="size-4" />المنصات (الاستيراد والتسويات)</Link></Button>
            ...
            <details open={hasFilters} className="rounded-lg border">
              ...
              <form className="grid gap-3 p-4 pt-0 sm:grid-cols-5 items-end">
                ...
                <div className="flex gap-2 sm:col-span-5">
                  ...
                  {hasFilters && <Button type="button" variant="outline" asChild><Link href="/erp/sales/orders">مسح</Link></Button>}
                </div>
              </form>
            </details>
