...
export default async function NewSalesOrderPage({
  ...
  return (
    <div className="space-y-6">
      <ErpPageHeader icon="ClipboardList" title="أمر بيع جديد" subtitle={initialLines ? "معبّأ من عرض السعر — راجِع وأكمل" : "التزام بيع — يُحوّل لفاتورة لاحقاً"} backHref="/erp/sales/orders" />
