...
export default async function NewQuotationPage() {
  ...
  return (
    <div className="space-y-6">
      <ErpPageHeader icon="FileText" title="عرض سعر جديد" subtitle="عرض أسعار للعميل — يُحوّل لأمر بيع عند القبول" backHref="/erp/sales/quotations" />
      <QuotationForm customers={custList} items={itemList} orgName={org[0]?.nameAr ?? "—"} />
    </div>
  );
}
