...
private val NAV = listOf(
    ...
    Section("المحاسبة", Icons.Filled.AccountBalance, null, listOf(
        Leaf("دليل الحسابات", null, "القيود والأستاذ"),
        ...
        Leaf("سندات القبض", null, "العملاء"),
        Leaf("كشف حساب العميل", null, "العملاء"),
        Leaf("سندات الصرف", null, "الموردون"),
        Leaf("كشف حساب المورّد", null, "الموردون"),
        Leaf("المصروفات", "expenses", "المصروفات والأصول"),
        Leaf("الأصول الثابتة", null, "المصروفات والأصول"),
        Leaf("الحسابات البنكية", null, "البنوك والخزينة"),
    ...
    Section("المشتريات", Icons.Filled.LocalShipping, null, listOf(
        Leaf("طلبات المواد", null, "دورة الشراء"),
        Leaf("أوامر الشراء", "purchase_orders", "دورة الشراء"),
        Leaf("إذون الاستلام", null, "دورة الشراء"),
    ...
    Section("المخزون", Icons.Filled.Inventory2, null, listOf(
        ...
        Leaf("أرصدة المخزون", "search", "الأصناف والأرصدة"),
        ...
        Leaf("تسويات المخزون", "adjust", "العمليات"),
        Leaf("التحويلات المخزنية", null, "العمليات"),
    ...
    Section("التقارير والتحليلات", Icons.Filled.Assessment, null, listOf(
        Leaf("ميزان المراجعة", "reports", "القوائم المالية"),
        Leaf("قائمة الدخل", "reports", "القوائم المالية"),
        Leaf("الميزانية العمومية", null, "القوائم المالية"),
        Leaf("التدفق النقدي", null, "القوائم المالية"),
        Leaf("ضريبة القيمة المضافة", null, "القوائم المالية"),
        Leaf("المؤشرات المالية", null, "التحليلات"),
    )),
    Section("الموردون", Icons.Filled.LocalShipping, "suppliers", emptyList()),
