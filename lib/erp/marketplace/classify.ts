...
export type PreviewOrder = {
  externalId: string; date: string; status: string; fulfillment?: string;
...
export function classifyOrders(
  ...
  for (const o of orders) {
    ...
    const po: PreviewOrder = { externalId: o.externalId, date: o.date, status: o.status, fulfillment: o.fulfillment, subtotal: o.subtotal, shippingTotal: o.shippingTotal, discount: o.discount, total: o.total, lines };
