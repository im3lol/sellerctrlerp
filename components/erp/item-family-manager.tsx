                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <div className="min-w-0">
                          ...
                          {isCurrent ? (
                            ...
                            <Link href={`/erp/inventory/items/${encodeURIComponent(m.code)}`} className="hover:text-primary"><span className="font-mono text-xs text-muted-foreground">{m.code}</span> {m.name}</Link>
                          )}
                        </div>
                      </div>
                    </TableCell>
