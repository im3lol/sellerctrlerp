...
export function LeaveRequestForm({ employees, orgName }: { employees: Employee[]; orgName: string }) {
    ...
    <Card>
      ...
      <CardContent className="space-y-5">
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
          ...
          <div className="space-y-2"><Label>المدة</Label><div className="flex h-9 items-center rounded-md border bg-muted/40 px-3 text-sm font-medium">{days > 0 ? `${days} يوم` : "—"}</div></div>
