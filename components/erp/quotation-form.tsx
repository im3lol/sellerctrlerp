...
const lineTotal = (l: Line) => round2(l.quantity * l.unitPrice - l.discountAmount + l.taxAmount);

export function QuotationForm({ customers, items, orgName }: { customers: Customer[]; items: Item[]; orgName: string }) {
