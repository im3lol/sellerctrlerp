...
/** Draft sales invoice: post (if allowed) or delete the draft. */
export function SalesInvoiceDetailActions({ id, status, canPost, canManage }: { id: string; status: string; canPost: boolean; canManage: boolean }) {
