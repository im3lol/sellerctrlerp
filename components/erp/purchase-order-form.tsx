...
export function PurchaseOrderForm({ suppliers, warehouses, items }: { suppliers: Supplier[]; warehouses: Warehouse[]; items: Item[] }) {
  ...
  const submit = () => {
    ...
    start(async () => {
      ...
      if (r.ok) { toast.success("تم إنشاء أمر الشراء"); router.push("/erp/purchases/orders"); router.refresh(); }
    ...
    <Card>
      ...
      <CardContent className="space-y-5">
        ...
        <div className="flex justify-end gap-2">
          <Button variant="outline" onClick={() => router.push("/erp/purchases/orders")}>إلغاء</Button>
